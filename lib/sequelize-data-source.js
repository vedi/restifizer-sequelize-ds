...
SequelizeDataSource.prototype._normalizeFields = function _normalizeFields(fields, filter, query) {
  query.include = this._resolveAssociations(this.ModelClass, fields, query.include);
...
SequelizeDataSource.prototype._resolveAssociations = function (ModelClass, fields, include) {
  include = include || [];
  var fieldsToRemove = [];
  _.each(fields, function (field) {
    ...
    if (association) {
      ...
      var associationFields = isObject ? field.fields : [association.targetKey];

      var nestedInclude = this._resolveAssociations(association.target, associationFields)
