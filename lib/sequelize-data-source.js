...
SequelizeDataSource.prototype._normalizeFields = function _normalizeFields(fields, filter, query) {
  ...
  fields = this._resolveAssociations(this.ModelClass, this.fieldMap, fields, query.include);
...
SequelizeDataSource.prototype._resolveAssociations = function (ModelClass, fieldMap, fields, include) {
  include = include || [];
  var fieldsToRemove = [];
  var result = _.map(fields, function (field) {
    ...
    if (fieldMeta && association) {
      ...
      associationFields = this._resolveAssociations(association.target, fieldMeta.fields, associationFields, nestedInclude);
